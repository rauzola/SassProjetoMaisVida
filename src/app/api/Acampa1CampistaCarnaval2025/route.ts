...
export async function POST(req: Request) {
  try {
    ...
    const novaInscricao = await prisma.acampa1CampistaCarnaval2025.create({
      data: body,
    });
   ...
   // Enviar e-mail para notificar o pedido de inscrição
      const EmailProjeto = {
        ...
        subject: `Nova Inscrição de um campista ${novaInscricao.id}`, // Assunto do e-mail
      ...
      const EmailProjetoRetorno = {
        ...
        subject: `Ficha de Inscrição - Carnaval 2025 | 1 à 4/03/25`, // Assunto do e-mail
